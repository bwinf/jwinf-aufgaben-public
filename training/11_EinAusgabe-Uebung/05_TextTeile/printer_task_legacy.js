   ...
   subTask.gridInfos = {
      ...
      includeBlocks: {
         ...
         standardBlocks: {
            includeAll: false,
            wholeCategories: [],
            singleBlocks: {easy:["text_getSubstring", "math_number"],medium:["text", "text_trim_noShadow", "text_indexOf", "text_getSubstring", "math_number", "math_arithmetic"],hard:["text", "text_join", "text_trim_noShadow", "text_indexOf", "text_getSubstring", "math_number", "math_arithmetic", "controls_untilWhile", "logic_negate"],},
         },
