    ...
    includeBlocks: {
      ...
      standardBlocks: {
        ...
        singleBlocks: {
          ...
          hard: ["lists_split", "lists_setIndex", "lists_getIndex", "controls_forEach", "math_number", "math_arithmetic", "lists_create_with_empty", "controls_for", "lists_length", "text_join", "text", "lists_repeat",],
          shared: [],
        },
      },
      variables: {
