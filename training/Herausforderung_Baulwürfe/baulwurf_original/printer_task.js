    ...
    includeBlocks: {
      ...
      standardBlocks: {
        ...
        singleBlocks: {
          ...
          shared: ["procedures_defnoreturn", "procedures_defreturn", "lists_create_with_empty", "controls_untilWhile", "controls_repeat_ext", "controls_for", "controls_forEach", "text", "text_length", "lists_repeat", "text_charAt", "lists_setIndex", "lists_split"],
        },
      },
      variables: {
